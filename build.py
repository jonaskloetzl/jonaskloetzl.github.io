...
def get_personal_data():
    name = ["Jonas", "Klötzl"]
    email = "jonas.kloetzl@gmail.com"
    # twitter = "JonasKloetzl"
    github = "jonaskloetzl"
    linkedin = "jonas-klötzl" #-41a3181ba"
    bio_text = f"""
                <p>
                ...
                <p>
                    ...
                    <a href="mailto:jonas.kloetzl@gmail.com" style="margin-right: 5px"><i class="far fa-envelope-open fa-lg"></i> Mail</a>
                    ...
                    <a href="https://github.com/jonaskloetzl" target="_blank" style="margin-right: 5px"><i class="fab fa-github fa-lg"></i> Github</a>
                    <a href="https://www.linkedin.com/in/jonas-klötzl-41a3181ba/" target="_blank" style="margin-right: 5px"><i class="fab fa-linkedin fa-lg"></i> LinkedIn</a>
...
def get_paper_entry(entry_key, entry):
    ...
    artefacts = {'html': 'Project Page', 'pdf': 'PDF', 'pdfsmall': 'PDF (small)', 'supp': 'Supplemental', 'video': 'Video', 'poster': 'Poster', 'code': 'Code'}
    i = 0
...
def get_talk_entry(entry_key, entry):
    ...
    artefacts = {'slides': 'Slides', 'video': 'Recording', 'html': 'Project Page', 'pdf': 'PDF', 'pdfsmall': 'PDF (small)', 'supp': 'Supplemental', 'video': 'Video', 'poster': 'Poster', 'code': 'Code'}
    i = 0
    for (k, v) in artefacts.items():
        if k in entry.fields.keys():
            if i > 0:
